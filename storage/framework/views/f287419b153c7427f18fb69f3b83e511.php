        ...
        <div class="container">
            <div class="header-info">
                <div class="logo-section">
                    <a href="/"><img src="<?php echo e(asset($setting['logo-light'])); ?>" alt="Logo" onerror="this.style.display='none'"></a>
                    <div class="logo-text">
    ...
    <div class="horizontal-menu">
        <div class="container">
            <ul class="nav-menu">
                ...
                <li class="<?php if($slug == 'tu-19-tuoi'): ?> current <?php endif; ?>">
                    <a href="/tu-19-tuoi">
                        <i class="fas fa-user"></i> Trên 19 tuổi
                    </a>
                </li>
                <li class="dropdown <?php if(in_array($slug, ['who-statistics', 'kythuatcando', 'huong-dan'])): ?> current <?php endif; ?>">
                    <a href="#">
                        <i class="fas fa-book"></i> Documents
                    </a>
                    <div class="dropdown-content">
                        <a href="/who-statistics.php" <?php if($slug == 'who-statistics'): ?> class="active" <?php endif; ?>>
                            <i class="fas fa-book-medical"></i> Chỉ dẫn phân loại WHO
                        </a>
                        <a href="/kythuatcando.php" <?php if($slug == 'kythuatcando'): ?> class="active" <?php endif; ?>>
                            <i class="fas fa-ruler-combined"></i> Kỹ thuật cân đo
                        </a>
                        <a href="/huong-dan-danh-gia-dinh-duong.html" <?php if($slug == 'huong-dan'): ?> class="active" <?php endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\dinhduong\resources\views/layouts/frontend-header.blade.php ENDPATH**/ ?>