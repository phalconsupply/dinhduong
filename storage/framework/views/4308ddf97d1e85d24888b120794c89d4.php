    ...
    // Đang dùng LMS
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card border-success">
                                        ...
                                        <div class="card-body">
                                            <p>1. Vào trang <a href="<?php echo e(route('admin.setting.index')); ?>">Cấu hình hệ thống</a></p>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p>
                                        <a href="<?php echo e(route('admin.setting.index')); ?>" class="btn btn-primary">
...
php artisan who:compare-methods --limit=1000 --export</code></pre>
                            ...
                            <div class="mt-4 text-center">
                                <a href="<?php echo e(route('admin.setting.index')); ?>" class="btn btn-primary btn-lg">
...
<?php echo $__env->make('admin.layouts.app-full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dinhduong\resources\views/admin/setting/zscore_info.blade.php ENDPATH**/ ?>