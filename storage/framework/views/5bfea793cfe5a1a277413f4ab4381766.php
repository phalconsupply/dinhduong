    ...
    <div class="col-12">
        <div class="card border-warning">
            <div class="card-header bg-warning bg-opacity-10 d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    9a. Tình trạng dinh dưỡng của trẻ dưới và bằng 2 tuổi (<= 24 tháng) - Phương pháp thay thế
                    <span class="badge bg-warning text-dark ms-2">So sánh</span>
                </h4>
                <div>
                    <button class="btn btn-warning btn-sm" onclick="exportTable('table-nutrition-under-2-alt', 'Tinh_trang_DD_duoi_bang_2_tuoi')">
                        <i class="uil uil-export"></i> Xuất Excel
                    </button>
                </div>
            </div>
            <div class="card-body">
                <div class="alert alert-warning mb-3">
                    <strong><i class="uil uil-comparison"></i> Khác biệt với Bảng 9:</strong>
                    <ul class="mb-0 mt-2" style="font-size: 13px;">
                        <li><strong>Đối tượng:</strong> Bảng 9 (< 24 tháng) → Bảng 9a (<strong><= 24 tháng</strong>) 
                            <span class="badge bg-info">+<?php echo e($table9aStats['total_children'] - $table9Stats['total_children']); ?> trẻ</span>
                        </li>
                        <li><strong>Điều kiện SDD:</strong> Bảng 9 (< -2SD) → Bảng 9a (<strong><= -2SD</strong>) - Bao gồm cả Z-score = -2.0</li>
                        <li><strong>Bình thường:</strong> Bảng 9 (>= -2 đến <= +2) → Bảng 9a (<strong>> -2 đến <= +2</strong>) - Loại trừ Z-score = -2.0</li>
                    </ul>
                </div>

                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="table-nutrition-under-2-alt">
                        <thead class="table-warning">
                            <tr>
                                <th class="fw-bold">Tình trạng dinh dưỡng</th>
                                <th class="text-center fw-bold">Tần số (n)</th>
                                <th class="text-center fw-bold">Tỷ lệ (%)</th>
                                <th class="text-center fw-bold" style="background-color: #ffe69c;">Chênh với B9</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- 1. Suy dinh dưỡng thể nhẹ cân (CN/T) -->
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể nhẹ cân (<= -2SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_age']['underweight']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_age']['underweight']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+<?php echo e($table9aStats['weight_for_age']['underweight']['count'] - $table9Stats['weight_for_age']['underweight']['count']); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_age']['normal']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_age']['normal']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-success">+<?php echo e($table9aStats['weight_for_age']['normal']['count'] - $table9Stats['weight_for_age']['normal']['count']); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Thừa cân (> +2SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_age']['overweight']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_age']['overweight']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table9aStats['weight_for_age']['overweight']['count'] - $table9Stats['weight_for_age']['overweight']['count'] >= 0 ? '+' : ''); ?><?php echo e($table9aStats['weight_for_age']['overweight']['count'] - $table9Stats['weight_for_age']['overweight']['count']); ?>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể thấp còi (<= -2SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['height_for_age']['stunted']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['height_for_age']['stunted']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+<?php echo e($table9aStats['height_for_age']['stunted']['count'] - $table9Stats['height_for_age']['stunted']['count']); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['height_for_age']['normal']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['height_for_age']['normal']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table9aStats['height_for_age']['normal']['count'] - $table9Stats['height_for_age']['normal']['count'] >= 0 ? '+' : ''); ?><?php echo e($table9aStats['height_for_age']['normal']['count'] - $table9Stats['height_for_age']['normal']['count']); ?>

                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Cao (> +2SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['height_for_age']['tall']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['height_for_age']['tall']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table9aStats['height_for_age']['tall']['count'] - $table9Stats['height_for_age']['tall']['count'] >= 0 ? '+' : ''); ?><?php echo e($table9aStats['height_for_age']['tall']['count'] - $table9Stats['height_for_age']['tall']['count']); ?>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể gầy còm (<= -2SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_height']['wasted']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_height']['wasted']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+<?php echo e($table9aStats['weight_for_height']['wasted']['count'] - $table9Stats['weight_for_height']['wasted']['count']); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_height']['normal']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_height']['normal']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table9aStats['weight_for_height']['normal']['count'] - $table9Stats['weight_for_height']['normal']['count'] >= 0 ? '+' : ''); ?><?php echo e($table9aStats['weight_for_height']['normal']['count'] - $table9Stats['weight_for_height']['normal']['count']); ?>

                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Thừa cân (> +2SD đến <= +3SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_height']['overweight']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_height']['overweight']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table9aStats['weight_for_height']['overweight']['count'] - $table9Stats['weight_for_height']['overweight']['count'] >= 0 ? '+' : ''); ?><?php echo e($table9aStats['weight_for_height']['overweight']['count'] - $table9Stats['weight_for_height']['overweight']['count']); ?>

                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Béo phì (> +3SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_height']['obese']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['weight_for_height']['obese']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table9aStats['weight_for_height']['obese']['count'] - $table9Stats['weight_for_height']['obese']['count'] >= 0 ? '+' : ''); ?><?php echo e($table9aStats['weight_for_height']['obese']['count'] - $table9Stats['weight_for_height']['obese']['count']); ?>
                            ...
                            <!-- 4. SDD thể phối hợp -->
                            <tr class="table-secondary">
                                <td colspan="4" class="fw-bold">4. Suy dinh dưỡng thể phối hợp</td>
                            </tr>
                            <tr>
                                <td class="ps-4">– SDD thể phối hợp (CN/CC <= -2SD VÀ CC/T <= -2SD)</td>
                                <td class="text-center"><?php echo e($table9aStats['combined']['combined_malnutrition']['count']); ?></td>
                                <td class="text-center"><?php echo e($table9aStats['combined']['combined_malnutrition']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+<?php echo e($table9aStats['combined']['combined_malnutrition']['count'] - $table9Stats['combined']['combined_malnutrition']['count']); ?></strong>
                                </td>
                            </tr>

                            <!-- 5. Tổng hợp -->
                            <tr class="table-secondary">
                                <td colspan="4" class="fw-bold">5. Tổng hợp (Ít nhất 1 trong 4 chỉ số SDD: CN/T, CC/T, CN/CC, BMI/T)</td>
                            </tr>
                            <tr class="table-info">
                                <td class="ps-4 fw-bold">– < 24 tháng SDD (Có ít nhất 1 trong 4 chỉ số <= -2SD)</td>
                                <td class="text-center fw-bold"><?php echo e($table9aStats['summary']['any_malnutrition']['count']); ?></td>
                                <td class="text-center fw-bold"><?php echo e($table9aStats['summary']['any_malnutrition']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25 fw-bold">
                                    <strong class="text-danger">+<?php echo e($table9aStats['summary']['any_malnutrition']['count'] - $table9Stats['summary']['any_malnutrition']['count']); ?></strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="alert alert-info mt-3">
                    <strong><i class="uil uil-info-circle"></i> So sánh kết quả:</strong>
                    <ul class="mb-0 mt-2" style="font-size: 13px;">
                        <li><strong>Tổng trẻ:</strong> Bảng 9a có thêm <?php echo e($table9aStats['total_children'] - $table9Stats['total_children']); ?> trẻ (9 trẻ đúng 24 tháng tuổi)</li>
                        <li><strong>SDD CN/T:</strong> +<?php echo e($table9aStats['weight_for_age']['underweight']['count'] - $table9Stats['weight_for_age']['underweight']['count']); ?> trẻ (do tính cả Z-score = -2.0)</li>
                        <li><strong>Ý nghĩa:</strong> Phương pháp này bao gồm cả trường hợp ranh giới (Z-score = -2.0) vào nhóm SDD thay vì nhóm bình thường</li>
                        <li><strong>Mục đích:</strong> So sánh để đánh giá ảnh hưởng của việc thay đổi tiêu chí phân loại</li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-12">
        <div class="card border-warning">
            <div class="card-header bg-warning bg-opacity-10 d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    10a. Tình trạng dinh dưỡng của trẻ dưới và bằng 5 tuổi (<= 60 tháng) - Phương pháp thay thế
                    <span class="badge bg-warning text-dark ms-2">So sánh</span>
                </h4>
                <div>
                    <button class="btn btn-warning btn-sm" onclick="exportTable('table-nutrition-under-5-alt', 'Tinh_trang_DD_duoi_bang_5_tuoi')">
                        <i class="uil uil-export"></i> Xuất Excel
                    </button>
                </div>
            </div>
            <div class="card-body">
                <div class="alert alert-warning mb-3">
                    <strong><i class="uil uil-comparison"></i> Khác biệt với Bảng 10:</strong>
                    <ul class="mb-0 mt-2" style="font-size: 13px;">
                        <li><strong>Đối tượng:</strong> Bảng 10 (< 60 tháng) → Bảng 10a (<strong><= 60 tháng</strong>) 
                            <span class="badge bg-info">+<?php echo e($table10aStats['total_children'] - $table10Stats['total_children']); ?> trẻ</span>
                        </li>
                        <li><strong>Điều kiện SDD:</strong> Bảng 10 (< -2SD) → Bảng 10a (<strong><= -2SD</strong>) - Bao gồm cả Z-score = -2.0</li>
                        <li><strong>Bình thường:</strong> Bảng 10 (>= -2 đến <= +2) → Bảng 10a (<strong>> -2 đến <= +2</strong>) - Loại trừ Z-score = -2.0</li>
                    </ul>
                </div>

                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="table-nutrition-under-5-alt">
                        <thead class="table-warning">
                            <tr>
                                <th class="fw-bold">Tình trạng dinh dưỡng</th>
                                <th class="text-center fw-bold">Tần số (n)</th>
                                <th class="text-center fw-bold">Tỷ lệ (%)</th>
                                <th class="text-center fw-bold" style="background-color: #ffe69c;">Chênh với B10</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- 1. Suy dinh dưỡng thể nhẹ cân (CN/T) -->
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể nhẹ cân (<= -2SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_age']['underweight']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_age']['underweight']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+<?php echo e($table10aStats['weight_for_age']['underweight']['count'] - $table10Stats['weight_for_age']['underweight']['count']); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_age']['normal']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_age']['normal']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-success">+<?php echo e($table10aStats['weight_for_age']['normal']['count'] - $table10Stats['weight_for_age']['normal']['count']); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Thừa cân (> +2SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_age']['overweight']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_age']['overweight']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table10aStats['weight_for_age']['overweight']['count'] - $table10Stats['weight_for_age']['overweight']['count'] >= 0 ? '+' : ''); ?><?php echo e($table10aStats['weight_for_age']['overweight']['count'] - $table10Stats['weight_for_age']['overweight']['count']); ?>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể thấp còi (<= -2SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['height_for_age']['stunted']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['height_for_age']['stunted']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+<?php echo e($table10aStats['height_for_age']['stunted']['count'] - $table10Stats['height_for_age']['stunted']['count']); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['height_for_age']['normal']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['height_for_age']['normal']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table10aStats['height_for_age']['normal']['count'] - $table10Stats['height_for_age']['normal']['count'] >= 0 ? '+' : ''); ?><?php echo e($table10aStats['height_for_age']['normal']['count'] - $table10Stats['height_for_age']['normal']['count']); ?>

                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Cao (> +2SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['height_for_age']['tall']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['height_for_age']['tall']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table10aStats['height_for_age']['tall']['count'] - $table10Stats['height_for_age']['tall']['count'] >= 0 ? '+' : ''); ?><?php echo e($table10aStats['height_for_age']['tall']['count'] - $table10Stats['height_for_age']['tall']['count']); ?>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể gầy còm (<= -2SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_height']['wasted']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_height']['wasted']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+<?php echo e($table10aStats['weight_for_height']['wasted']['count'] - $table10Stats['weight_for_height']['wasted']['count']); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_height']['normal']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_height']['normal']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table10aStats['weight_for_height']['normal']['count'] - $table10Stats['weight_for_height']['normal']['count'] >= 0 ? '+' : ''); ?><?php echo e($table10aStats['weight_for_height']['normal']['count'] - $table10Stats['weight_for_height']['normal']['count']); ?>

                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Thừa cân (> +2SD đến <= +3SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_height']['overweight']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_height']['overweight']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table10aStats['weight_for_height']['overweight']['count'] - $table10Stats['weight_for_height']['overweight']['count'] >= 0 ? '+' : ''); ?><?php echo e($table10aStats['weight_for_height']['overweight']['count'] - $table10Stats['weight_for_height']['overweight']['count']); ?>

                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Béo phì (> +3SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_height']['obese']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['weight_for_height']['obese']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <?php echo e($table10aStats['weight_for_height']['obese']['count'] - $table10Stats['weight_for_height']['obese']['count'] >= 0 ? '+' : ''); ?><?php echo e($table10aStats['weight_for_height']['obese']['count'] - $table10Stats['weight_for_height']['obese']['count']); ?>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể phối hợp (CN/CC <= -2SD VÀ CC/T <= -2SD)</td>
                                <td class="text-center"><?php echo e($table10aStats['combined']['combined_malnutrition']['count']); ?></td>
                                <td class="text-center"><?php echo e($table10aStats['combined']['combined_malnutrition']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+<?php echo e($table10aStats['combined']['combined_malnutrition']['count'] - $table10Stats['combined']['combined_malnutrition']['count']); ?></strong>
                                </td>
                            </tr>
                            ...
                            <tr class="table-info">
                                <td class="ps-4 fw-bold">– < 60 tháng SDD (Có ít nhất 1 trong 4 chỉ số <= -2SD)</td>
                                <td class="text-center fw-bold"><?php echo e($table10aStats['summary']['any_malnutrition']['count']); ?></td>
                                <td class="text-center fw-bold"><?php echo e($table10aStats['summary']['any_malnutrition']['percentage']); ?>%</td>
                                <td class="text-center bg-warning bg-opacity-25 fw-bold">
                                    <strong class="text-danger">+<?php echo e($table10aStats['summary']['any_malnutrition']['count'] - $table10Stats['summary']['any_malnutrition']['count']); ?></strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="alert alert-info mt-3">
                    <strong><i class="uil uil-info-circle"></i> So sánh kết quả:</strong>
                    <ul class="mb-0 mt-2" style="font-size: 13px;">
                        <li><strong>Tổng trẻ:</strong> Bảng 10a có thêm <?php echo e($table10aStats['total_children'] - $table10Stats['total_children']); ?> trẻ (trẻ đúng 60 tháng tuổi - nếu có)</li>
                        <li><strong>SDD CN/T:</strong> +<?php echo e($table10aStats['weight_for_age']['underweight']['count'] - $table10Stats['weight_for_age']['underweight']['count']); ?> trẻ (do tính cả Z-score = -2.0)</li>
                        <li><strong>Ý nghĩa:</strong> Phương pháp này bao gồm cả trường hợp ranh giới (Z-score = -2.0) vào nhóm SDD thay vì nhóm bình thường</li>
                        <li><strong>Mục đích:</strong> So sánh để đánh giá ảnh hưởng của việc thay đổi tiêu chí phân loại trên toàn bộ nhóm trẻ dưới 5 tuổi</li>
                    </ul>
                </div>
            </div>
        </div>
