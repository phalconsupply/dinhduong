...
<script>
    (function () {
        ...
        let weight = <?php echo e($row->weight ?? 0); ?>;
        ...
        let config = {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Biểu đồ 3: Cân nặng theo chiều cao (bé <?php echo e($row->gender == 1 ? "trai" : "gái"); ?>)',
                        font: { size: 12 }
                    },
...
<?php /**PATH C:\xampp\htdocs\dinhduong\resources\views/sections/Chart-WeightForHeight.blade.php ENDPATH**/ ?>