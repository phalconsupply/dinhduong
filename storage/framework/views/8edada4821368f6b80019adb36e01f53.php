            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 d-lg-block d-none">
                    <div class="card border-bottom pb-4">
                        ...
                        <div class="card-body">
                            <div class="card-title"><h5>Thêm đơn vị</h5></div>
                            <form action="<?php echo e(route('admin.units.store')); ?>" method="POST">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="name" id="name" type="text" class="form-control ps-5" placeholder="Tên đơn vị" value="<?php echo e(old('name')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="user" class="fea icon-sm icons"></i>
                                                    <input name="phone" id="phone" type="text" class="form-control ps-5"  value="<?php echo e(old('phone')); ?>" placeholder="Số điện thoại đơn vị" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="user" class="fea icon-sm icons"></i>
                                                    <input name="email" id="email" type="email" class="form-control ps-5" placeholder="Thư điện tử đơn vị" value="<?php echo e(old('email')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <select name="type_id" id="type_id" class="form-select form-control pl-45px" aria-label="Default select example" required>
                                                        ...
                                                        <?php $__currentLoopData = $unit_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="map-pin" class="fea icon-sm icons"></i>
                                                    <input name="address" id="address" type="text" class="form-control ps-5" value="<?php echo e(old('address')); ?>" placeholder="Địa chỉ" required>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <select name="province_code" id="province_code" class="pl-45px form-select form-control " aria-label="Default select example" required>
                                                        ...
                                                        <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($province->code); ?>" <?php if(old('province_code') == $province->code): ?> selected <?php endif; ?>><?php echo e($province->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <select name="district_code" id="district_code" class="pl-45px form-select form-control " aria-label="Default select example" required>
                                                        ...
                                                        <?php $__currentLoopData = old('districts') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($district->code); ?>" <?php if($district->code == old('district_code')): ?> selected <?php endif; ?>><?php echo e($district->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <select name="ward_code" id="ward_code" class="pl-45px form-select form-control " aria-label="Default select example" required>
                                                        ...
                                                        <?php $__currentLoopData = old('wards') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ward): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($ward->code); ?>" <?php if($ward->code == old('ward_code')): ?> selected <?php endif; ?>><?php echo e($ward->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="col-md-12">
                                            <div class="form-check form-switch">
                                                <input name="is_active" class="form-check-input" type="checkbox" id="is_active" <?php if(old('is_active') == 'on'): ?> checked <?php endif; ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="thumb" id="thumb" value="<?php echo e(old('thumb')); ?>" type="text" onclick="selectFileWithCKFinder('thumb')" class="form-control ps-5" placeholder="Nhập link ảnh">
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                ...
                                <div class="row mt-3">
                                    <div class="col-8 ta-r">
                                        <input type="submit" id="submit" name="send" class="btn btn-sm btn-primary" value="Thêm đơn vị">
                                    </div><!--end col-->
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('admin.layouts.app-full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dinhduong\resources\views/admin/units/create.blade.php ENDPATH**/ ?>