        ...
        let config = {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Biểu đồ 2: Cân nặng theo tuổi (bé <?php echo e($row->gender == 1 ? "trai" : "gái"); ?>)',
                        font: { size: 12 }
                    },
...
<?php /**PATH C:\xampp\htdocs\dinhduong\resources\views/sections/Chart-WeightForAge.blade.php ENDPATH**/ ?>