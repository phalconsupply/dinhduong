                ...
                <div class="container">
                    ...
                    <div class="heading-wrapper">
                        ...
                        <div class="action-buttons">
                            <a class="btn-action btn-print" href="<?php echo e(url('/in?uid=' . $row->uid)); ?>" target="_blank">
                                <i class="fas fa-print"></i> In kết quả
                            </a>
                            <?php if(Auth::check()): ?>
                            <a class="btn-action btn-edit" href="<?php echo e(url('/' . $row->slug."?edit=".$row->uid)); ?>">
                        ...
                        <div class="col-xs-12 col-md-4">
                            ...
                            <div class="form-section-card">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                    <div class="pro5-avatar <?php echo e($colorClass); ?>">
                                        <div id="avatar-wapper" style="border: 1px dashed #ccc; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 20px;">
                                            <img id="avatar-preview" src="<?php echo e($row->thumb ?? asset('/web/frontend/images/ava01.png')); ?>" alt="Avatar" style="max-width: 100%; max-height: 300px; display: block; border-radius: 8px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="info-grid">
                                        <div class="info-item">
                                            ...
                                            <p class="info-value"><?php echo e($row->fullname); ?></p>
                                        </div>
                                        <div class="info-item">
                                            <label><i class="fas fa-venus-mars"></i> Giới tính</label>
                                            <p class="info-value"><?php echo e($row->get_gender()); ?></p>
                                        </div>
                                        <div class="info-item">
                                            <label><i class="fas fa-birthday-cake"></i> Ngày sinh</label>
                                            <p class="info-value"><?php echo e($row->birthday ? $row->birthday->format('d/m/Y') : ''); ?></p>
                                        </div>
                                        <div class="info-item">
                                            <label><i class="fas fa-globe-asia"></i> Dân tộc</label>
                                            <p class="info-value"><?php echo e($row->ethnic->name); ?></p>
                                        </div>
                                        <div class="info-item">
                                            <label><i class="fas fa-calendar-alt"></i> Số tháng tuổi</label>
                                            <p class="info-value"><?php echo e($row->age); ?> tháng</p>
                                        </div>
                                        <div class="info-item">
                    ...
                    <?php if($row->slug == '' || $row->slug == 'tu-0-5-tuoi'): ?>
                        ...
                        <div class="form-section-card result-block">
                            ...
                            <div class="card-body">
                                <div class="nutrition-status-badge" style="background-color: <?php echo e($nutrition_status['color']); ?>; padding: 20px; border-radius: 8px; text-align: center;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="results-table">
                                    <table class="table-modern">
                                        ...
                                        <tbody>
                                            <tr class="result-row" style="background-color: <?php echo e($weight_for_age['color']); ?>;">
                                                <td>
                                            ...
                                            <tr class="result-row" style="background-color: <?php echo e($height_for_age['color']); ?>;">
                                                <td>
                                            ...
                                            <tr class="result-row" style="background-color: <?php echo e($weight_for_height['color']); ?>;">
                                                <td>
                                            ...
                                            <tr class="result-row" style="background-color: <?php echo e($bmi_for_age['color']); ?>;">
                                                <td>
                    ...
                    <div class="form-section-card result-block">
                        ...
                        <div class="card-body">
                            ...
                            <div id="advices_content" class="nuti-recommendations">
                                ...
                                <?php echo $default_advice; ?>

                                
                                <?php if($row->advice_content): ?>
                            ...
                            <div class="amz-contact-expert" style="margin-top: 30px; padding: 20px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 8px; text-align: center; color: white;">
                                ...
                                <p style="margin: 0; font-size: 16px; font-weight: 500;">
                                    Hãy liên hệ Chuyên gia Dinh dưỡng theo số <strong style="font-size: 20px;"><?php echo e($setting['phone'] ?? 'N/A'); ?></strong> để được tư vấn thêm.
                                </p>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startPush('foot'); ?>
    ...
    <script>
        ...
        (function() {
            const month = <?php echo e($row->age ?? 0); ?>;
            const height = <?php echo e($row->height ?? 0); ?>;
            const weight = <?php echo e($row->weight ?? 0); ?>;
            const bmi = <?php echo e($row->bmi ?? 0); ?>;
            const gender = <?php echo e($row->gender ?? 1); ?>;
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#save_advices').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("admin.history.update_advice")); ?>',
                    type: 'POST',
                    data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dinhduong\resources\views/ketqua.blade.php ENDPATH**/ ?>