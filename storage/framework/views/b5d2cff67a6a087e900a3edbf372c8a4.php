...
<?php $__env->startSection('content'); ?>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input name="logo-light" value="<?php echo e($setting['logo-light']); ?>" onclick="selectFileWithCKFinder('logo-light')" id="logo-light" type="text" class="form-control ps-5" placeholder="Mật khẩu hiện tại :">
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                <i class="ti ti-hexagon fea icon-sm icons"></i>
                                                <input name="name"  value="<?php echo e($setting['name']); ?>" id="name"  type="text" class="form-control ps-5" placeholder="Nhập tên công ty">
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input name="phone" value="<?php echo e($setting['phone']); ?>" id="phone" type="text" class="form-control ps-5" placeholder="Nhập số điện thoại">
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                <i class="ti ti-phone fea icon-sm icons"></i>
                                                <input name="hotline" value="<?php echo e($setting['hotline']); ?>" id="hotline" type="text" class="form-control ps-5" placeholder="Nhập hotline">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input name="address" value="<?php echo e($setting['address']); ?>" id="address" type="text" class="form-control ps-5" placeholder="Nhập địa chỉ công ty">
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                <i class="ti ti-hexagon fea icon-sm icons"></i>
                                                <input name="site-title" value="<?php echo e($setting['site-title']); ?>" id="site-title" type="text" class="form-control ps-5" placeholder="Nhập tiêu đề website">
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <textarea name="site-description" class="form-control ps-5"><?php echo $setting['site-description']; ?></textarea>
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                <i class="ti ti-text-wrap fea icon-sm icons"></i>
                                                <textarea name="site-keywords" class="form-control ps-5"><?php echo $setting['site-keywords']; ?></textarea>
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="zscore_method" class="form-control" id="zscore_method">
                                                <option value="lms" <?php echo e((isset($setting['zscore_method']) && $setting['zscore_method'] == 'lms') ? 'selected' : ''); ?>>
                                                    WHO LMS 2006 (Khuyến nghị)
                                                </option>
                                                <option value="sd_bands" <?php echo e((isset($setting['zscore_method']) && $setting['zscore_method'] == 'sd_bands') ? 'selected' : ''); ?>>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <a href="<?php echo e(route('admin.setting.zscore_info')); ?>" class="btn btn-sm btn-outline-info" target="_blank">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function runComparison() {
            ...
            fetch('<?php echo e(route("admin.setting.compare_methods")); ?>')
...
<?php echo $__env->make('admin.layouts.app-full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dinhduong\resources\views/admin/setting/index.blade.php ENDPATH**/ ?>