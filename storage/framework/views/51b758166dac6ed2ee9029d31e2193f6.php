<div class="d-flex justify-content-between align-items-center mb-3">
    <h6 class="mb-0">
        ...
        <?php if(!empty($stats) && !empty($stats['all'])): ?>
            <span class="badge bg-success ms-2">
                <i class="uil uil-check"></i> <?php echo e($stats['all']['stats']['total']['n'] ?? 0); ?> bản ghi
            </span>
        <?php endif; ?>
    </h6>
    <div>
...
<?php else: ?>
    ...
    <div class="tab-content" id="who-combined-content">
        ...
        <div class="tab-pane fade show active" id="all-content" role="tabpanel">
            <?php echo $__env->make('admin.statistics.tabs.partials.who-table', ['data' => $stats['all']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        
        <div class="tab-pane fade" id="male-content" role="tabpanel">
            <?php echo $__env->make('admin.statistics.tabs.partials.who-table', ['data' => $stats['male']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        
        <div class="tab-pane fade" id="female-content" role="tabpanel">
            <?php echo $__env->make('admin.statistics.tabs.partials.who-table', ['data' => $stats['female']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
<?php endif; ?>
...
</script><?php /**PATH C:\xampp\htdocs\dinhduong\resources\views/admin/statistics/tabs/who-combined.blade.php ENDPATH**/ ?>