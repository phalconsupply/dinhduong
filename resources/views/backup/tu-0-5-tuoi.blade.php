                        ...
                        <form class="pro5-form" action="{{ route('form.post', ['slug' => $slug]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="pro5-info">
                                <div class="pro5-input">
                                    <div class="row">
                                        <input id="category-user-profile" type="hidden" name="category" value="1">
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                            ...
                                            <div class="form-group calendar-group">
                                                <input type="text" name="cccd" value="{{old('cccd', $item->cccd)}}" class="form-control" id="cccd" placeholder="cccd">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                            <div class="form-group gender-group">
                                                ...
                                                <select name="gender" class=" form-control" data-placeholder="Giới tính" style="width: 100%;">
                                                    ...
                                                    <option value="2" @if($item->gender == old('gender', 2)) selected @endif>Nữ</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4">
