        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-7 col-lg-8">
                    <h3 class="heading">
                        <strong>Tình trạng dinh dưỡng cho người trên 19 tuổi</strong>
                    </h3>

                    <p><strong>Lưu ý:</strong> Chỉ số BMI sẽ không chính xác nếu bạn là vận động viên, người tập thể
                        hình (bởi các múi cơ luôn nặng hơn mỡ), và cũng không chính xác với bà mẹ mang thai hay đang
                        cho con bú.</p>
                    <br>
                    <div class="">
                            ...
                            <form class="pro5-form" action="{{ route('form.post', ['slug' => $slug]) }}" method="POST" enctype="multipart/form-data">
                                <div class="pro5-avatar">
                                    ...
                                    <div id="avatar-wapper" class="yellow" style="cursor: pointer; border: 1px dashed #ccc; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                                        <img id="avatar-preview" src="{{ asset('/web/frontend/images/ava03.png') }}" alt="Avatar" style="max-width: 100%; max-height: 100%; display: block;">
                                ...
                                <div class="pro5-info">
                                    <div class="pro5-input">
                                        <div class="row">
                                            <input id="category-user-profile" type="hidden" name="category" value="3">
                                            <div class="col-xs-12 col-sm-4">
                                                <div class="form-group">
                                                    <p>Họ và tên (<span class="text-danger">*</span>)</p>
                                                    <input type="text" name="fullname" value="{{old('fullname')}}" class="form-control" id="last-name" placeholder="Họ và tên" required>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4">
                                                <p>Mã định danh (CCCD)</p>
                                                <div class="form-group calendar-group">
                                                    <input type="text" name="cccd" value="{{old('cccd')}}" class="form-control" id="cccd" placeholder="cccd">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4">
                                                <div class="form-group">
                                                    <p>Số điện thoại</p>
                                                    <input type="number" minlength="10" maxlength="11" name="phone" value="{{old('phone')}}" class="form-control" id="phone" placeholder="Điện thoại">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-4">
                                                <div class="form-group gender-group">
                                                    ...
                                                    <select name="gender" value="{{old('gender')}}" class=" form-control" data-placeholder="Giới tính" style="width: 100%;">
                                                ...
                                                <div class="form-group gender-group">
                                                    ...
                                                    <select name="ethnic_id" id="ethnic_id" class="form-select form-control text-end" aria-label="Default select example" required="">
                                                        @foreach($ethnics as $ethnic)
                                                            <option value="{{ $ethnic->id }}" @if(old('ethnic_id') && old('ethnic_id') == $ethnic->id) selected @endif>{{ $ethnic->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-4">
                                                ...
                                                <div class="form-group calendar-group">
                                                    <input type="text" name="cal_date" value="{{old('cal_date')}}" class="form-control" id="cal-date" placeholder="Ngày cân đo dd/mm/yyyy" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="address" value="{{old('address')}}" class="form-control" id="address" placeholder="Địa chỉ" required>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4">
                                                <div class="form-group gender-group">
                                                    ...
                                                    <select name="province_code" id="province_code" class=" form-control" data-placeholder="Tỉnh/Thành phố" style="width: 100%;" required>
                                                        ...
                                                        @foreach($provinces as $province)
                                                            <option value="{{ $province->code }}" @if(old('province_code') && old('province_code') == $province->code) selected @endif>{{ $province->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <select name="district_code" id="district_code" class="form-select form-control text-end" aria-label="Default select example" required="">
                                                        ...
                                                        @if(old('district_code'))
                                                            @foreach(session('districts') as $district)
                                                                <option value="{{ $district->code }}" @if(old('district_code') && old('district_code') == $district->code) selected @endif>{{ $district->name }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                                    ...
                                                    <select name="ward_code" id="ward_code" class="form-select form-control text-end" aria-label="Default select example" required="">
                                                        ...
                                                        @if(old('ward_code'))
                                                            @foreach(session('wards') as $ward)
                                                                <option value="{{ $ward->code }}" @if(old('ward_code') && old('ward_code') == $ward->code) selected @endif>{{ $ward->name }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                ...
                                <div class="row from-number">
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <input id="weight-user-profile" min="0" type="number" step="0.1" required="" name="weight" value="{{old('weight')}}" class="form-control" placeholder="Nặng 000.0" aria-describedby="addon1">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <input id="length-user-profile" type="number" step="0.1" min="0" required="" name="height" value="{{old('height')}}" class="form-control" placeholder="Cao 000.0" aria-describedby="addon2">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <input name="age_show" value="{{old('age_show')}}"class="form-control" placeholder="Số tuổi" aria-describedby="addon3" id="age_show" title="" type="number" min="19" style="padding: 6px 8px;">
                                            <input name="age" value="{{old('age')}}" id="age" title="" type="hidden">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <input id="bmi-user-profile" type="text" name="bmi" value="{{old('bmi')}}" class="form-control" placeholder="Số BMI" aria-describedby="addon4" readonly="">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(window).load(function() {
                    ...
                    success: function (response) {
                        ...
                        if (category == 1) {
                            ...
                            if( months >= 61 && months < 72 ){
                                ...
                                $("#addon3").text('');
                                $('#age_show').val(getAge(birthdate, date) );
            ...
            if (category === 3) {
                $("#age_show").change(function () {
                    var date = new Date();
                    var age = $("#age_show").val()
