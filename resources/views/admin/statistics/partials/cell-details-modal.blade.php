{{-- Modal for Cell Details - Shows list of children when user clicks on table cells --}}
...
function showCellDetails(cell) {
    ...
    // Build URL
    const url = `{{ route('admin.statistics.cell_details') }}?${params.toString()}`;
