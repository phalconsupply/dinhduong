        ...
        <div class="card border-warning">
            ...
            <div class="card-body">
                <div class="alert alert-warning mb-3">
                    ...
                    <ul class="mb-0 mt-2" style="font-size: 13px;">
                        <li><strong>Đối tượng:</strong> Bảng 9 (< 24 tháng) → Bảng 9a (<strong><= 24 tháng</strong>) 
                            <span class="badge bg-info">+{{ $table9aStats['total_children'] - $table9Stats['total_children'] }} trẻ</span>
                        </li>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="table-nutrition-under-2-alt">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể nhẹ cân (<= -2SD)</td>
                                <td class="text-center">{{ $table9aStats['weight_for_age']['underweight']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['weight_for_age']['underweight']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+{{ $table9aStats['weight_for_age']['underweight']['count'] - $table9Stats['weight_for_age']['underweight']['count'] }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center">{{ $table9aStats['weight_for_age']['normal']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['weight_for_age']['normal']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-success">+{{ $table9aStats['weight_for_age']['normal']['count'] - $table9Stats['weight_for_age']['normal']['count'] }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Thừa cân (> +2SD)</td>
                                <td class="text-center">{{ $table9aStats['weight_for_age']['overweight']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['weight_for_age']['overweight']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table9aStats['weight_for_age']['overweight']['count'] - $table9Stats['weight_for_age']['overweight']['count'] >= 0 ? '+' : '' }}{{ $table9aStats['weight_for_age']['overweight']['count'] - $table9Stats['weight_for_age']['overweight']['count'] }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể thấp còi (<= -2SD)</td>
                                <td class="text-center">{{ $table9aStats['height_for_age']['stunted']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['height_for_age']['stunted']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+{{ $table9aStats['height_for_age']['stunted']['count'] - $table9Stats['height_for_age']['stunted']['count'] }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center">{{ $table9aStats['height_for_age']['normal']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['height_for_age']['normal']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table9aStats['height_for_age']['normal']['count'] - $table9Stats['height_for_age']['normal']['count'] >= 0 ? '+' : '' }}{{ $table9aStats['height_for_age']['normal']['count'] - $table9Stats['height_for_age']['normal']['count'] }}
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Cao (> +2SD)</td>
                                <td class="text-center">{{ $table9aStats['height_for_age']['tall']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['height_for_age']['tall']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table9aStats['height_for_age']['tall']['count'] - $table9Stats['height_for_age']['tall']['count'] >= 0 ? '+' : '' }}{{ $table9aStats['height_for_age']['tall']['count'] - $table9Stats['height_for_age']['tall']['count'] }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể gầy còm (<= -2SD)</td>
                                <td class="text-center">{{ $table9aStats['weight_for_height']['wasted']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['weight_for_height']['wasted']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+{{ $table9aStats['weight_for_height']['wasted']['count'] - $table9Stats['weight_for_height']['wasted']['count'] }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center">{{ $table9aStats['weight_for_height']['normal']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['weight_for_height']['normal']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table9aStats['weight_for_height']['normal']['count'] - $table9Stats['weight_for_height']['normal']['count'] >= 0 ? '+' : '' }}{{ $table9aStats['weight_for_height']['normal']['count'] - $table9Stats['weight_for_height']['normal']['count'] }}
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Thừa cân (> +2SD đến <= +3SD)</td>
                                <td class="text-center">{{ $table9aStats['weight_for_height']['overweight']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['weight_for_height']['overweight']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table9aStats['weight_for_height']['overweight']['count'] - $table9Stats['weight_for_height']['overweight']['count'] >= 0 ? '+' : '' }}{{ $table9aStats['weight_for_height']['overweight']['count'] - $table9Stats['weight_for_height']['overweight']['count'] }}
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Béo phì (> +3SD)</td>
                                <td class="text-center">{{ $table9aStats['weight_for_height']['obese']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['weight_for_height']['obese']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table9aStats['weight_for_height']['obese']['count'] - $table9Stats['weight_for_height']['obese']['count'] >= 0 ? '+' : '' }}{{ $table9aStats['weight_for_height']['obese']['count'] - $table9Stats['weight_for_height']['obese']['count'] }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể phối hợp (CN/CC <= -2SD VÀ CC/T <= -2SD)</td>
                                <td class="text-center">{{ $table9aStats['combined']['combined_malnutrition']['count'] }}</td>
                                <td class="text-center">{{ $table9aStats['combined']['combined_malnutrition']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+{{ $table9aStats['combined']['combined_malnutrition']['count'] - $table9Stats['combined']['combined_malnutrition']['count'] }}</strong>
                                </td>
                            </tr>
                            ...
                            <tr class="table-info">
                                ...
                                <td class="text-center fw-bold">{{ $table9aStats['summary']['any_malnutrition']['count'] }}</td>
                                <td class="text-center fw-bold">{{ $table9aStats['summary']['any_malnutrition']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25 fw-bold">
                                    <strong class="text-danger">+{{ $table9aStats['summary']['any_malnutrition']['count'] - $table9Stats['summary']['any_malnutrition']['count'] }}</strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="alert alert-info mt-3">
                    ...
                    <ul class="mb-0 mt-2" style="font-size: 13px;">
                        <li><strong>Tổng trẻ:</strong> Bảng 9a có thêm {{ $table9aStats['total_children'] - $table9Stats['total_children'] }} trẻ (9 trẻ đúng 24 tháng tuổi)</li>
                        <li><strong>SDD CN/T:</strong> +{{ $table9aStats['weight_for_age']['underweight']['count'] - $table9Stats['weight_for_age']['underweight']['count'] }} trẻ (do tính cả Z-score = -2.0)</li>
        ...
        <div class="card border-warning">
            ...
            <div class="card-body">
                <div class="alert alert-warning mb-3">
                    ...
                    <ul class="mb-0 mt-2" style="font-size: 13px;">
                        <li><strong>Đối tượng:</strong> Bảng 10 (< 60 tháng) → Bảng 10a (<strong><= 60 tháng</strong>) 
                            <span class="badge bg-info">+{{ $table10aStats['total_children'] - $table10Stats['total_children'] }} trẻ</span>
                        </li>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="table-nutrition-under-5-alt">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể nhẹ cân (<= -2SD)</td>
                                <td class="text-center">{{ $table10aStats['weight_for_age']['underweight']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['weight_for_age']['underweight']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+{{ $table10aStats['weight_for_age']['underweight']['count'] - $table10Stats['weight_for_age']['underweight']['count'] }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center">{{ $table10aStats['weight_for_age']['normal']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['weight_for_age']['normal']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-success">+{{ $table10aStats['weight_for_age']['normal']['count'] - $table10Stats['weight_for_age']['normal']['count'] }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Thừa cân (> +2SD)</td>
                                <td class="text-center">{{ $table10aStats['weight_for_age']['overweight']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['weight_for_age']['overweight']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table10aStats['weight_for_age']['overweight']['count'] - $table10Stats['weight_for_age']['overweight']['count'] >= 0 ? '+' : '' }}{{ $table10aStats['weight_for_age']['overweight']['count'] - $table10Stats['weight_for_age']['overweight']['count'] }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể thấp còi (<= -2SD)</td>
                                <td class="text-center">{{ $table10aStats['height_for_age']['stunted']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['height_for_age']['stunted']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+{{ $table10aStats['height_for_age']['stunted']['count'] - $table10Stats['height_for_age']['stunted']['count'] }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center">{{ $table10aStats['height_for_age']['normal']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['height_for_age']['normal']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table10aStats['height_for_age']['normal']['count'] - $table10Stats['height_for_age']['normal']['count'] >= 0 ? '+' : '' }}{{ $table10aStats['height_for_age']['normal']['count'] - $table10Stats['height_for_age']['normal']['count'] }}
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Cao (> +2SD)</td>
                                <td class="text-center">{{ $table10aStats['height_for_age']['tall']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['height_for_age']['tall']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table10aStats['height_for_age']['tall']['count'] - $table10Stats['height_for_age']['tall']['count'] >= 0 ? '+' : '' }}{{ $table10aStats['height_for_age']['tall']['count'] - $table10Stats['height_for_age']['tall']['count'] }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể gầy còm (<= -2SD)</td>
                                <td class="text-center">{{ $table10aStats['weight_for_height']['wasted']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['weight_for_height']['wasted']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+{{ $table10aStats['weight_for_height']['wasted']['count'] - $table10Stats['weight_for_height']['wasted']['count'] }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Bình thường (> -2SD đến <= +2SD)</td>
                                <td class="text-center">{{ $table10aStats['weight_for_height']['normal']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['weight_for_height']['normal']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table10aStats['weight_for_height']['normal']['count'] - $table10Stats['weight_for_height']['normal']['count'] >= 0 ? '+' : '' }}{{ $table10aStats['weight_for_height']['normal']['count'] - $table10Stats['weight_for_height']['normal']['count'] }}
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Thừa cân (> +2SD đến <= +3SD)</td>
                                <td class="text-center">{{ $table10aStats['weight_for_height']['overweight']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['weight_for_height']['overweight']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table10aStats['weight_for_height']['overweight']['count'] - $table10Stats['weight_for_height']['overweight']['count'] >= 0 ? '+' : '' }}{{ $table10aStats['weight_for_height']['overweight']['count'] - $table10Stats['weight_for_height']['overweight']['count'] }}
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-4">– Béo phì (> +3SD)</td>
                                <td class="text-center">{{ $table10aStats['weight_for_height']['obese']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['weight_for_height']['obese']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    {{ $table10aStats['weight_for_height']['obese']['count'] - $table10Stats['weight_for_height']['obese']['count'] >= 0 ? '+' : '' }}{{ $table10aStats['weight_for_height']['obese']['count'] - $table10Stats['weight_for_height']['obese']['count'] }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="ps-4">– SDD thể phối hợp (CN/CC <= -2SD VÀ CC/T <= -2SD)</td>
                                <td class="text-center">{{ $table10aStats['combined']['combined_malnutrition']['count'] }}</td>
                                <td class="text-center">{{ $table10aStats['combined']['combined_malnutrition']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25">
                                    <strong class="text-danger">+{{ $table10aStats['combined']['combined_malnutrition']['count'] - $table10Stats['combined']['combined_malnutrition']['count'] }}</strong>
                                </td>
                            </tr>
                            ...
                            <tr class="table-info">
                                ...
                                <td class="text-center fw-bold">{{ $table10aStats['summary']['any_malnutrition']['count'] }}</td>
                                <td class="text-center fw-bold">{{ $table10aStats['summary']['any_malnutrition']['percentage'] }}%</td>
                                <td class="text-center bg-warning bg-opacity-25 fw-bold">
                                    <strong class="text-danger">+{{ $table10aStats['summary']['any_malnutrition']['count'] - $table10Stats['summary']['any_malnutrition']['count'] }}</strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="alert alert-info mt-3">
                    <strong><i class="uil uil-info-circle"></i> So sánh kết quả:</strong>
                    <ul class="mb-0 mt-2" style="font-size: 13px;">
                        <li><strong>Tổng trẻ:</strong> Bảng 10a có thêm {{ $table10aStats['total_children'] - $table10Stats['total_children'] }} trẻ (trẻ đúng 60 tháng tuổi - nếu có)</li>
                        <li><strong>SDD CN/T:</strong> +{{ $table10aStats['weight_for_age']['underweight']['count'] - $table10Stats['weight_for_age']['underweight']['count'] }} trẻ (do tính cả Z-score = -2.0)</li>
                        <li><strong>Ý nghĩa:</strong> Phương pháp này bao gồm cả trường hợp ranh giới (Z-score = -2.0) vào nhóm SDD thay vì nhóm bình thường</li>
