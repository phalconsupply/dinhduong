            ...
            <div class="card">
                <div class="card-body">
                    <table  id="transactions-table"  class="table bg-white mb-0">
                        <thead>
                        <tr>
                            <th class="border-bottom ">Year:Month</th>
                            <th class="border-bottom ">Months</th>
                        ...
                        @foreach($results as $row)
                            <tr class="existing-row" data-id="{{$row['id']}}">
                                <td><input data-id="{{$row['id']}}" data-key="Year_Month" type="text" value="{{ $row['Year_Month'] }}" class="form-control form-control-sm"></td>
                                <td><input data-id="{{$row['id']}}" data-key="Months" type="text" value="{{ $row['Months'] }}" class="form-control form-control-sm"></td>
                                <td><input data-id="{{$row['id']}}" data-key="-1SD" type="text" value="{{ $row['-3SD'] }}" class="form-control form-control-sm"></td>
