...
<div class="row mt-3">
    <div class="col-lg-12">
        <ul class="nav nav-pills nav-tabs flex-column flex-sm-row rounded" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a href="{{route('admin.type.index', ['tab'=>'weight-for-age'])}}" class="nav-link  @if($tab == 'weight-for-age') active @endif" id="shipping-tab"  >
            ...
            <li  class="nav-item">
                <a href="{{route('admin.type.index', ['tab'=>'height-for-age'])}}" class="nav-link  @if($tab == 'height-for-age') active @endif" id="info-tab"   >
                    <div class="text-center py-2">
            ...
            <li class="nav-item">
                <a href="{{route('admin.type.index', ['tab'=>'weight-for-height'])}}" class="nav-link  @if($tab == 'weight-for-height') active @endif" id="payment-tab"  >
                    <div class="text-center py-2">
            ...
            <li class="nav-item">
                <a href="{{route('admin.type.index', ['tab'=>'bmi-for-age'])}}" class="nav-link  @if($tab == 'bmi-for-age') active @endif" id="info-tab"   >
                    <div class="text-center py-2">
...
<script type="text/template" id="rowTemplate">
    <tr data-id="__index__">
        @foreach($columns as $col)
            <td><input name="{{$col}}[]" type="text" class="form-control form-control-sm" required></td>
        @endforeach
        <td>
