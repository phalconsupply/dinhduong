...
$submitted_password = getPost('password');
...
<?php
} elseif ($submitted_password !== $CLEAR_PASSWORD) {
?>
    <div class="error">
        <strong>❌ Password không đúng!</strong><br>
        Vui lòng thử lại với password chính xác.
    </div>
    <a href="<?php echo getServer('PHP_SELF', 'clear_cache_simple.php'); ?>" class="button">Thử lại</a>
...
<?php if ($submitted_password === $CLEAR_PASSWORD): ?>
setTimeout(function() {
