                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="name" id="name" type="text" class="form-control ps-5" placeholder="Tên đơn vị" value="{{old('name')}}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="user" class="fea icon-sm icons"></i>
                                                    <input name="phone" id="phone" type="text" class="form-control ps-5"  value="{{old('phone')}}" placeholder="Số điện thoại đơn vị" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="user" class="fea icon-sm icons"></i>
                                                    <input name="email" id="email" type="email" class="form-control ps-5" placeholder="Thư điện tử đơn vị" value="{{old('email')}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
