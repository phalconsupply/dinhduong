    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-7 col-lg-8">
                <h3 class="heading">
                    <strong>Tình trạng dinh dưỡng của trẻ từ 5-19 tuổi</strong>
                </h3>
                        ...
                        <form class="pro5-form" action="{{ route('form.post', ['slug' => $slug]) }}" method="POST" enctype="multipart/form-data">
                            <div class="pro5-avatar">
                                ...
                                <div id="avatar-wapper" class="pink" style="cursor: pointer; border: 1px dashed #ccc; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                                    <img id="avatar-preview" src="{{ asset('/web/frontend/images/ava02.png') }}" alt="Avatar" style="max-width: 100%; max-height: 100%; display: block;">
                            ...
                            <div class="pro5-info">
                                <div class="pro5-input">
                                    <div class="row">
                                        <input id="category-user-profile" type="hidden" name="category" value="2">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4">
                                            ...
                                            <div class="form-group calendar-group">
                                                <input type="text" name="birthday" value="{{old('birthday')}}" class="form-control" id="calendar-birth" placeholder="dd/mm/yyyy" required>
                                                <input id="over19" type="hidden" name="over19" value="{{old('over19')}}" />
                            ...
                            <div class="row from-number">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <input name="age_show" value="{{old('age_show')}}" class="form-control" placeholder="Số tuổi" aria-describedby="addon3" id="age_show" title="" type="text" readonly="" style="padding: 6px 8px;">
                                        <input name="age" id="age" value="{{old('age')}}" type="hidden">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <input id="bmi-user-profile" type="text" name="bmi" value="" class="form-control" placeholder="Số BMI" aria-describedby="addon4" readonly="">
                            ...
                            <div class="row reset_margin_l_r">
                                @if ($errors->any())
